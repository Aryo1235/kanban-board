...
export default function LandingPage() {
  return (
    <div className="container mx-auto min-h-screen px-4 py-12 max-w-[1350px] bg-gray-900 text-white ">
      {/* Hero Section */}
      <section
        className="flex items-end justify-center rounded-md  py-4 h-[550px] mx-auto bg-green-800 bg-no-repeat bg-cover bg-center w-full"
        style={{
          backgroundImage: "url('/hero-section.svg')",
        }}
      >
        <div className="flex  flex-col items-center pb-20">
          <h1 className="text-4xl md:text-6xl font-bold mb-4  text-gray-100 text-center drop-shadow-lg">
            Manage Your Task With KanbanBoard
          </h1>
          <h3 className="text-lg md:text-2xl mb-8 text-center font-semibold text-gray-100  drop-shadow">
      ...
      <section className="flex flex-col pt-10 ">
        <div>
          ...
          <h3 className="text-lg md:text-lg mb-4 text-gray-100 drop-shadow">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-2">
            ...
            <div className="bg-gray-800 p-4 rounded-md">
              ...
              <p className="text-sm">
                ...
                rem exercitationem perspiciatis voluptates modi officia itaque
                odio alias temporibus! Ipsum?.
              </p>
            </div>
            <div className="bg-gray-800 p-4 rounded-md">
              ...
              <p className="text-sm">
                ...
                dibuka oleh user yang sudah login. Privasi dan keamanan menjadi
                prioritas utama dalam setiap aktivitas di KanbanBoard.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="w-full mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-6">
            ...
            <div className="group bg-gray-800 border-2 border-gray-700 rounded-xl p-6 flex flex-col items-center transition-transform hover:scale-105 hover:border-green-500 shadow-lg cursor-pointer">
              ...
              <span className="font-semibold mb-1 text-lg">Daftar / Login</span>
              <span className="text-gray-300 text-sm text-center">
                Masuk dengan email atau Google untuk mulai menggunakan aplikasi.
              </span>
            </div>
            {/* Step 2 */}
