      ...
      <div className="bg-gray-800 p-8 rounded shadow-md w-80">
        ...
        {!showReset ? (
          <form onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              className="w-full bg-lime-600 hover:bg-lime-700 cursor pointer text-white font-bold py-2 px-4 rounded mb-2"
              disabled={loading}
            >
            ...
            <button
              type="button"
              className="w-full text-lime-400 hover:underline text-sm mb-2 cursor-pointer"
            ...
            <button
              type="button"
              className="w-full cursor-pointer text-blue-400 hover:underline text-sm mb-2"
